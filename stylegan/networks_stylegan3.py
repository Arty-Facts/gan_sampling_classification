...
class Generator(torch.nn.Module):
    def __init__(self,
        ...
        fourier_features = None,       # Number of Fourier features.
        ...
        **synthesis_kwargs,         # Arguments for SynthesisNetwork.
        ...
        self.mapping = MappingNetwork(z_dim=z_dim, c_dim=self.c_dim_m, w_dim=w_dim, num_ws=self.num_ws, **mapping_kwargs)
